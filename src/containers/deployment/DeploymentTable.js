...
const onViewSettings = (cluster, id, deployment_type, deployment_version, pageKey) => {
  if (pageKey) {
    return routerActions.navigateTo(`deployment_settings.${pageKey}`, {
      cluster, id, deployment_type, deployment_version,
    })
  }
  return routerActions.navigateTo('deployment_settings', {
    cluster, id, deployment_type, deployment_version,
  })
}
